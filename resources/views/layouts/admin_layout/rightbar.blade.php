            ...
            <nav class="horizontal-nav mobile-navbar fixed-navbar">
                <div class="collapse navbar-collapse" id="navbar-menu">
                    <ul class="horizontal-menu">
                        ...
                        <li class="dropdown">
                            <a href="javaScript:void();" class="dropdown-toggle" data-toggle="dropdown"><i class="ri-apps-line"></i><span>Apps</span></a>
                            <ul class="dropdown-menu">
                                <li><a href="apps-calender">Calender</a></li>
                                <li><a href="apps-chat">Chat</a></li>
                                <li class="dropdown">
                                    <a href="javaScript:void();" class="dropdown-toggle" data-toggle="dropdown">Email</a>
                                    <ul class="dropdown-menu">
                                        <li><a href="{{url('/apps-email-inbox')}}"></i>Inbox</a></li>
                                        <li><a href="{{url('/apps-email-open')}}"></i>Open</a></li>
                                        <li><a href="{{url('/apps-email-compose')}}"></i>Compose</a></li>
                                    </ul>
                                </li>
                                <li><a href="apps-kanban-board"></i>Kanban Board</a></li>
                                <li><a href="apps-onboarding-screens"></i>Onboarding Screens</a></li>
                            </ul>
                        </li>                            
                        <li class="dropdown">
                            <a href="javaScript:void();" class="dropdown-toggle" data-toggle="dropdown"><i class="ri-pantone-line"></i><span>Components</span></a>
                            <ul class="dropdown-menu">
                                <li class="dropdown">
                        ...
                        <li class="dropdown">
                            <a href="javaScript:void();" class="dropdown-toggle" data-toggle="dropdown"><i class="ri-pages-line"></i><span>Pages</span></a>
                            <ul class="dropdown-menu">
                                <li class="dropdown">
                        ...
                        <li class="dropdown menu-item-has-mega-menu">
                            <a href="javaScript:void();" class="dropdown-toggle" data-toggle="dropdown"><i class="ri-pencil-ruler-line"></i><span>Basic UI</span></a>
                        ...
                        <li class="dropdown">
                            <a href="javaScript:void();" class="dropdown-toggle" data-toggle="dropdown"><i class="ri-pencil-ruler-2-line"></i><span>Advanced UI</span></a>
                            <ul class="dropdown-menu">
                        ...
                        <li class="scroll"><a href="widgets"><i class="ri-palette-line"></i><span>Widgets</span><span class="new-icon"></span></a></li>
                    </ul>
                </div>
            </nav>
            <!-- End Horizontal Nav -->
